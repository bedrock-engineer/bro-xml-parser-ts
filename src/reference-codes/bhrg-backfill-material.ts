/**
 * BackfillMaterial code descriptions from the official BRO reference.
 *
 * Keyed by code; resolve a {@link Coded} value's description with `describe`
 * rather than importing this table directly.
 *
 * @generated from urn:bro:bhrg:BackfillMaterial
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrg%3ABackfillMaterial
 */

export const BHRG_BACKFILL_MATERIAL_CODES: Record<string, string> = {
  ...
  grind: 'Grind dat gezeefd is en uit korrels bestaat met een grootte die tussen 2 en 6,3 mm ligt.',
  grindZand: 'Een mengsel van zand en grind dat gezeefd is en uit korrels bestaat met een grootte die tussen 63 ?m en 6,3 mm ligt.',
  grindZandGrof: 'Een mengsel van zand en grind dat gezeefd is en uit korrels bestaat met een grootte die tussen 0,63 en 6,3 mm ligt.',
  grindZandOngezeefd: 'Een mengsel van zand en grind dat niet gezeefd is. Deze categorie omvat onder meer materiaal dat wordt aangeduid met termen als metselzand en ophoogzand.',
  ...
  kleiZwelklasseOnbekend: 'Korrels die bestaan uit klei met een onbekend zwelvermogen. Aan dit materiaal is geen detecteerbare stof toegevoegd.',
  kleiZwelklasseOnbekendDetecteerbaar: 'Korrels die bestaan uit klei met een onbekend zwelvermogen, met een toevoeging van een detecteerbare stof.',
  verwijderdMateriaal: 'Het gat is opgevuld met de opgeboorde grond of de weggegraven ondergrond.',
  wegverhardingsmateriaal: 'Materiaal dat gebruikt is voor het verharden van wegen en erven; voorbeelden zijn asfalt, betonklinkers, klinkers, steenslag en tegels.',
  zand: 'Zand dat gezeefd is en uit korrels bestaat met een grootte die tussen 63 ?m en 2 mm ligt.',
  zandGrof: 'Zand dat gezeefd is en uit korrels bestaat met een grootte die tussen 0,63 en 2 mm ligt.',
  zandMiddelgrof: 'Zand dat gezeefd is en uit korrels bestaat met een grootte die tussen 0,2 en 0,63 mm ligt.',
  zandMiddelgrofGrof: 'Zand dat gezeefd is en uit korrels bestaat met een grootte die tussen 0,2 en 2 mm ligt.',
};
