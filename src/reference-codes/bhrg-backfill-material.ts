...
export const BHRG_BACKFILL_MATERIAL_CODES: Record<string, string> = {
  ...
  grindZand:
    "Een mengsel van zand en grind dat gezeefd is en uit korrels bestaat met een grootte die tussen 63 ?m en 6,3 mm ligt.",
  grindZandGrof:
 ...
 */
export function getBhrgBackfillMaterialDescription(code: string): string | undefined {
  return BHRG_BACKFILL_MATERIAL_CODES[code];
}
