/**
 * BoringProcedure code descriptions from the official BRO reference.
 *
...
export const BHRGT_BORING_PROCEDURE_CODES: Record<string, string> = {
  ...
  'SIKB2001vanafV6.0': 'SIKB protocol 2001 Plaatsen van handboringen en peilbuizen, maken van boorbeschrijvingen, nemen van grondmonsters en waterpassen. Versie 6.0 en opvolgende versies die geen relevante wijzigingen voor (de gegevens van) het booronderzoek bevatten.',
  'SIKB2101vanafV3.3': 'SIKB protocol 2101 Mechanisch boren. Versie 3.3 en opvolgende versies die geen relevante wijzigingen voor (de gegevens van) het booronderzoek bevatten.',
};
