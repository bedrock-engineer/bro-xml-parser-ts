/**
 * Colour codes and descriptions from the official BRO reference.
 *
 * @generated from urn:bro:bhrgt:Colour
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrgt%3AColour
 */

export const BHRGT_COLOUR_CODES: Record<string, string> = {
  blauw: "Blauw zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  bruin: "Bruin zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  donkerblauw:
  ...
  geel: "Geel zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  grijs: "Grijs zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  groen: "Groen zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  lichtblauw:
  ...
  olijf: "Olijf zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  oranje: "Oranje zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  paars: "Paars zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  rood: "Rood zonder aanduiding van licht of donker zoals gebruikt onder NEN 5104.",
  standaardBlauw:
...
/**
 * Get the Dutch description for a Colour code.
 *
 * @param code - The code value
 * @returns The Dutch description, or undefined if the code is not recognized
 */
export function getBhrgtColourDescription(code: string): string | undefined {
  return BHRGT_COLOUR_CODES[code];
}
