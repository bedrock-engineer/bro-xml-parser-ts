/**
 * PeatType codes and descriptions from the official BRO reference.
 *
...
/**
 * Get the Dutch description for a PeatType code.
 *
 * @param code - The code value
 * @returns The Dutch description, or undefined if the code is not recognized
 */
export function getBhrgPeatTypeDescription(code: string): string | undefined {
  return BHRG_PEAT_TYPE_CODES[code];
}
