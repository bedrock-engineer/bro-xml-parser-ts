/**
 * GravelMedianClass code descriptions from the official BRO reference.
 *
...
export const BHRG_GRAVEL_MEDIAN_CLASS_CODES: Record<string, string> = {
  ...
  fijnNEN5104: 'De grindmediaan is gelijk aan of groter dan 2 mm en kleiner dan 5,6 mm. Een klasse onder de NEN 5104 procedure.',
  ...
  matigGrofNEN5104: 'De grindmediaan is gelijk aan of groter dan 5,6 mm en kleiner dan 16 mm. Een klasse onder de NEN 5104 procedure.',
  middelgrof: 'De grindmediaan is groter dan 6,3 mm en kleiner dan of gelijk aan 20 mm. Een klasse onder de NEN-EN-ISO 14688 procedure.',
  onbekend: 'De mediaan van de grindfractie is niet bekend.',
  zeerGrofNEN5104: 'De grindmediaan is gelijk aan of groter dan 16 mm en kleiner dan 63 mm. Een klasse onder de NEN 5104 procedure.',
};
