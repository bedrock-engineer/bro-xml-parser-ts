/**
 * MaterialShape code descriptions from the official BRO reference.
 *
...
export const BHRG_MATERIAL_SHAPE_CODES: Record<string, string> = {
  ...
  sedimentlenzen: 'Een of meer geïsoleerde, duidelijk begrensde, lensvormige voorkomens die herkend worden als in deeltjes afgezet.',
};
