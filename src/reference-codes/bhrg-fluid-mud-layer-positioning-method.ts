 ...
 */
export function getBhrgFluidMudLayerPositioningMethodDescription(code: string): string | undefined {
  return BHRG_FLUID_MUD_LAYER_POSITIONING_METHOD_CODES[code];
}
