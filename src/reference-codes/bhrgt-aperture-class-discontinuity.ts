/**
 * ApertureClassDiscontinuity codes and descriptions from the official BRO reference.
 *
...
/**
 * Get the Dutch description for a ApertureClassDiscontinuity code.
 *
 * @param code - The code value
 * @returns The Dutch description, or undefined if the code is not recognized
 */
export function getBhrgtApertureClassDiscontinuityDescription(code: string): string | undefined {
  return BHRGT_APERTURE_CLASS_DISCONTINUITY_CODES[code];
}
