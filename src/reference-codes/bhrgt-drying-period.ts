...
export const BHRGT_DRYING_PERIOD_CODES: Record<string, string> = {
  ...
  stabieleMassa: 'Het materiaal is gedroogd tot het materiaal een stabiele massa heeft en dat is wanneer de massa van het materiaal niet meer veranderd na een uur drogen.',
};
