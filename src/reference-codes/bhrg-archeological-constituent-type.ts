/**
 * ArcheologicalConstituentType code descriptions from the official BRO reference.
 *
...
export const BHRG_ARCHEOLOGICAL_CONSTITUENT_TYPE_CODES: Record<string, string> = {
  ...
  gebrokenKwarts: 'Gebroken, hoekig gesteentegruis, enkele millimeters groot, dat herkend wordt als gebruikt voor de verschraling van klei voor het vervaardigen van keramische objecten, bijvoorbeeld potten.',
  ...
  natuursteen: 'Steen die herkend wordt als een door de mens behandeld of verwerkte brok gesteente.',
  verbrandeLeem: 'Leem of klei die door blootstelling aan hitte geblakerd of gebakken is.',
  verbrandingsresten: 'Minerale verbrandingsresten en amorfe bijproducten van verbranding of verbranding of verhitting die niet uit leem bestaan.',
