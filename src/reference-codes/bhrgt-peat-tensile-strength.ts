/**
 * PeatTensileStrength code descriptions from the official BRO reference.
 *
...
export const BHRGT_PEAT_TENSILE_STRENGTH_CODES: Record<string, string> = {
  ...
  matig: 'De vezels grijpen in elkaar. Bij monsters met een matige treksterkte wordt weerstand gevoeld bij het uit elkaar trekken van de grond. De vezels blijven aan elkaar haken en vormen een netwerk dat de grond ondersteunt',
};
