 ...
 *
 * @generated from urn:bro:bhrg:HorizontalPositioningMethod
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrg%3AHorizontalPositioningMethod
 */

export const BHRG_HORIZONTAL_POSITIONING_METHOD_CODES: Record<string, string> = {
  DGPS0tot100cm:
 ...
 */
export function getBhrgHorizontalPositioningMethodDescription(code: string): string | undefined {
  return BHRG_HORIZONTAL_POSITIONING_METHOD_CODES[code];
}
