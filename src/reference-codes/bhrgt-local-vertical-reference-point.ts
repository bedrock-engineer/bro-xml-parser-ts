 ...
 *
 * @generated from urn:bro:bhrgt:LocalVerticalReferencePoint
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrgt%3ALocalVerticalReferencePoint
 */

export const BHRGT_LOCAL_VERTICAL_REFERENCE_POINT_CODES: Record<string, string> = {
  maaiveld:
 ...
 */
export function getBhrgtLocalVerticalReferencePointDescription(code: string): string | undefined {
  return BHRGT_LOCAL_VERTICAL_REFERENCE_POINT_CODES[code];
}
