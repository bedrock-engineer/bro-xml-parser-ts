 ...
 *
 * @generated from urn:bro:bhrgt:DeliveryContext
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrgt%3ADeliveryContext
 */

export const BHRGT_DELIVERY_CONTEXT_CODES: Record<string, string> = {
 ...
 */
export function getBhrgtDeliveryContextDescription(code: string): string | undefined {
  return BHRGT_DELIVERY_CONTEXT_CODES[code];
}
