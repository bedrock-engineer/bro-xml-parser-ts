/**
 * SurveyProcedure code descriptions from the official BRO reference.
 *
...
export const BHRGT_SURVEY_PROCEDURE_CODES: Record<string, string> = {
  ...
  ISO19901d8v2015: 'NEN-EN-ISO 19901-8:2015 Aardolie- en aardgasindustrie - Specifieke eisen voor buitengaatse constructies - Deel 8: Zeebodemonderzoeken. Een internationale norm geaccepteerd door Europa en Nederland.',
