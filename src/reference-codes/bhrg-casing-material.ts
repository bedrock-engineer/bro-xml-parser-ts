/**
 * CasingMaterial code descriptions from the official BRO reference.
 *
...
export const BHRG_CASING_MATERIAL_CODES: Record<string, string> = {
  ...
  pePvc: 'De buis bestaat uit polyethyleen en pvc, waarbij onbekend is of het high density of low density polyethyleen betreft.',
