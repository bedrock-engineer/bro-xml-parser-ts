/**
 * MunsellHue code descriptions from the official BRO reference.
 *
...
export const BHRG_MUNSELL_HUE_CODES: Record<string, string> = {
  ...
  '10YR': 'De waarde van de hoofdkleur is 10YR. Dit staat voor de hoofdkleur geel rood (Yellow Red).',
  '2.5Y': 'De waarde van de hoofdkleur is 2,5Y. Dit staat voor de kleur geel (Yellow).',
  '2.5YR': 'De waarde van de hoofdkleur is 2,5YR. Dit staat voor de hoofdkleur geel rood (Yellow Red).',
  ...
  '7.5YR': 'De waarde van de hoofdkleur is 7,5YR. Dit staat voor de hoofdkleur geel rood (Yellow Red).',
