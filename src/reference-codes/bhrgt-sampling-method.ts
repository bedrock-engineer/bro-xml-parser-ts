 ...
 *
 * @generated from urn:bro:bhrgt:SamplingMethod
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrgt%3ASamplingMethod
 */

export const BHRGT_SAMPLING_METHOD_CODES: Record<string, string> = {
  graven:
 ...
 */
export function getBhrgtSamplingMethodDescription(code: string): string | undefined {
  return BHRGT_SAMPLING_METHOD_CODES[code];
}
