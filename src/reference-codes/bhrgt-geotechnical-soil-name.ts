/**
 * GeotechnicalSoilName codes and descriptions from the official BRO reference.
 *
 * @generated from urn:bro:bhrgt:GeotechnicalSoilName
 * @see https://publiek.broservices.nl/bro/refcodes/v1/codes?domain=urn%3Abro%3Abhrgt%3AGeotechnicalSoilName
 */

export const BHRGT_GEOTECHNICAL_SOIL_NAME_CODES: Record<string, string> = {
  bruinkool: "Organische grond die compact is en een hoge treksterkte heeft.",
  detritus:
  ...
  gyttja: "Organische grond die amorf is, stroef aanvoelt en een pasta-achtige consistentie heeft.",
  humus:
  ...
  klei: "Fijne minerale grond die zich gedraagt als klei, geen grind of zeer grof materiaal en geen zichtbaar of voelbaar zand bevat.",
  kleiigeDetritus: "Organische grond die uit detritus bestaat en waarneembaar klei bevat.",
  kleiigeHumus: "Organische grond die uit humus bestaat en waarneembaar klei bevat.",
  kleiigGrind:
  ...
  kleiigVeen: "Organische grond die uit veen bestaat en waarneembaar klei bevat.",
  kleiigZand:
  ...
  kleiMetKeien: "Fijne minerale grond die zich gedraagt als klei en keien bevat.",
  kleiMetKeitjes: "Fijne minerale grond die zich gedraagt als klei en keitjes bevat.",
  silt: "Fijne minerale grond die zich gedraagt als silt, geen grind of zeer grof materiaal en geen zichtbaar of voelbaar zand (bij uitsmeren over de hand) bevat.",
  siltigeDetritus: "Organische grond die uit detritus bestaat en waarneembaar silt bevat.",
  siltigeHumus: "Organische grond die uit humus bestaat en waarneembaar silt bevat.",
  siltigGrind:
    "Grove minerale grond, waarvan de grove fractie bestaat uit grind met daartussen fijn materiaal dat zich gedraagt als silt.",
  siltigVeen: "Organische grond die uit veen bestaat en waarneembaar silt bevat.",
  siltigZand:
  ...
  siltMetKeien: "Fijne minerale grond die zich gedraagt als silt en keien bevat.",
  siltMetKeitjes: "Fijne minerale grond die zich gedraagt als silt en keitjes bevat.",
  sterkGrindigeKlei:
    "Fijne minerale grond die zich gedraagt als klei, veel grindkorrels en geen zichtbaar of voelbaar zand bevat.",
  sterkGrindigSilt: "Fijne minerale grond die zich gedraagt als silt en veel grindkorrels bevat.",
  sterkGrindigZand:
  ...
  veen: "Organische grond die uit veen bestaat, een vezelig en samenhangend organisch materiaal met enige treksterkte dat bestaat uit de nog gedeeltelijk als zodanig herkenbare delen van planten.",
  zand: "Grove minerale grond, waarvan de grove fractie uit zand bestaat, zonder waarneembare bijmenging.",
  zandMetKeien:
  ...
  zwakGrindigSilt: "Fijne minerale grond die zich gedraagt als silt en enkele grindkorrels bevat.",
  zwakGrindigZand:
...
/**
 * Get the Dutch description for a GeotechnicalSoilName code.
 *
 * @param code - The code value
 * @returns The Dutch description, or undefined if the code is not recognized
 */
export function getBhrgtGeotechnicalSoilNameDescription(code: string): string | undefined {
  return BHRGT_GEOTECHNICAL_SOIL_NAME_CODES[code];
}
