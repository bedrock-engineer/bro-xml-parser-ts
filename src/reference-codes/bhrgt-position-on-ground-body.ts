/**
 * PositionOnGroundBody code descriptions from the official BRO reference.
 *
...
export const BHRGT_POSITION_ON_GROUND_BODY_CODES: Record<string, string> = {
  binnenteen: 'De binnenteen is de overgang van het talud naar het maaiveld aan de binnenzijde (bij dijken de landzijde) van het grondlichaam.',
  buitenteen: 'De buitenteen is de overgang van het talud naar het maaiveld aan de buitenzijde (bij dijken de waterzijde) van het grondlichaam.',
