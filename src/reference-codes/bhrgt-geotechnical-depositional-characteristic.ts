/**
 * GeotechnicalDepositionalCharacteristic codes and descriptions from the official BRO reference.
 *
...
/**
 * Get the Dutch description for a GeotechnicalDepositionalCharacteristic code.
 *
 * @param code - The code value
 * @returns The Dutch description, or undefined if the code is not recognized
 */
export function getBhrgtGeotechnicalDepositionalCharacteristicDescription(
  code: string,
): string | undefined {
  return BHRGT_GEOTECHNICAL_DEPOSITIONAL_CHARACTERISTIC_CODES[code];
}
